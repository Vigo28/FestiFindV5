...
namespace FestiFindV5.Data.Migrations
{
    ...
    [Migration("20231019195911_EventOrderUpdate2")]
    partial class EventOrderUpdate2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FestiFindV5.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FestFindV2.Models.Event", b =>
                {
                    b.HasOne("FestiFindV5.Models.Category", "Category")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("FestFindV2.Models.Order", b =>
                {
                    b.HasOne("FestFindV2.Models.Event", "Event")
                        .WithOne("order")
                        .HasForeignKey("FestFindV2.Models.Order", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FestFindV2.Models.Participant", "Participant")
                        .WithMany("Orders")
